    ...
    <section id="services">
      <div class="container" id="printableArea">
        <div class="section-header">
          ...
          <div class="btn-group"><a href="crud/addkec.php">
                ...
                <td>
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="crud/editkec.php?id_kecamatan=<?php echo $d['id_kecamatan']; ?>">Edit</a>
                      <a class="dropdown-item" href="crud/deletekec.php?id_kecamatan=<?php echo $d['id_kecamatan']; ?>" onclick="return confirm('Hapus data ini ?')">Hapus</a>
