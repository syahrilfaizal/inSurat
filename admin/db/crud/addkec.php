    ...
    <section id="contact" class="wow fadeInUp">
      ...
      <div class="container">
        <div class="form">
          ...
          <form action="paddkec.php" method="post"   enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label style="font-weight: bold; color: royalblue; ">Nama Camat</label>
              <textarea class="form-control" name="nama_camat" ></textarea>
              <div class="validation"></div>
            </div>
