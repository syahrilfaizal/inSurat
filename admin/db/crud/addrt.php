    ...
    <section id="contact" class="wow fadeInUp">
      ...
      <div class="container">
        <div class="form">
          ...
          <form action="paddrt.php" method="post"   enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label style="font-weight: bold; color: royalblue; ">Ketua RT</label>
              <textarea class="form-control" name="nama_rt" ></textarea>
              <div class="validation"></div>
            </div>
            <div class="form-group">
