      ...
      <div class="container">
        <div class="form">
          <?php 
            include "conf.php";
            $id = $_GET['id_rt'];
            $d = mysqli_query($conn,"SELECT * from rt where id_rt = '$id'");
            while($data = mysqli_fetch_array($d)){
            ?>
          <form action="peditrt.php" method="post">
                  <div class="mb-3">
                    <input type="hidden" name="id_rt" value="<?= $data['id_rt'] ?>" class="form-control" >
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <label class="form-label" style="font-weight: bold; color: royalblue; ">Ketua_RT</label>
