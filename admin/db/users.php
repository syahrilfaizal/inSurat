    ...
    <section id="services">
      <div class="container" id="printableArea">
        <div class="section-header">
          ...
          <div class="btn-group"><a href="crud/adduser.php">
          ...
          <table  class="table table-hover ">
            ...
            <?php
              ...
              INNER JOIN rt ON user.id_rt = rt.id_rt
              INNER JOIN kelurahan ON user.id_kelurahan = kelurahan.id_kelurahan
                ...
                <td>
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="crud/edituser.php?id_user=<?php echo $d['id_user']; ?>">Edit</a>
                      <a class="dropdown-item"  href="crud/deleteuser.php?id_user=<?php echo $d['id_user']; ?>" onclick="return confirm('Hapus data ini ?')">Hapus</a>
