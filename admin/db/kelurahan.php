    ...
    <section id="services">
      <div class="container" id="printableArea">
        <div class="section-header">
          ...
          <div class="btn-group"><a href="crud/addkel.php">
          ...
          <table  class="table table-hover ">
            ...
            <?php
              include '../conf.php';
              $no = 1;
              $data = mysqli_query($conn,"SELECT * from kelurahan
                ...
                <td>
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="crud/editkel.php?id_kelurahan=<?php echo $d['id_kelurahan']; ?>">Edit</a>
                      <a class="dropdown-item"  href="crud/deletekel.php?id_kelurahan=<?php echo $d['id_kelurahan']; ?>" onclick="return confirm('Hapus data ini ?')">Hapus</a>
