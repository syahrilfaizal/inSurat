    ...
    <a class="logo">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="db/kecamatan.php">data kecamatan</a></li>
          <li><a href="db/kelurahan.php">data kelurahan</a></li>
          <li><a href="db/rt.php">data rt</a></li>
          <li><a href="db/users.php">user</a></li>
                ...
                <td>
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item"  href="crud/deletekec.php?id=<?php echo $d['id_kecamatan']; ?>" onclick="return confirm('Hapus data ini ?')">Hapus</a>
